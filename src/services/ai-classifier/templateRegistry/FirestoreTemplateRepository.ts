...
export class FirestoreTemplateRepository
{
  ...
  {
    const snap: FirebaseFirestore.QuerySnapshot<FirebaseFirestore.DocumentData, FirebaseFirestore.DocumentData> = await this.client.firestore.collection(settings.TEMPLATE_COLLECTION).get();
