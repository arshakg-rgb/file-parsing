...
class AiClassifierService extends ServiceManager {
  protected static instance: AiClassifierService;
  private ai: GoogleGenAI;

  protected constructor(enforce: () => void) {
    if (enforce !== Enforce) {
      throw new InstantiationError("Cannot instantiate AiClassifierService directly. Use getInstance()");
    }
    super(enforce);
  ...
  public static getInstance(): AiClassifierService {
    if (!ServiceManager.instance) {
      ServiceManager.instance = new AiClassifierService(Enforce);
    }
    return ServiceManager.instance as AiClassifierService;
  }
