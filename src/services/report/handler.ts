...
class ReportService extends ServiceManager {
  ...
  private constructor(enforce: () => void) {
    if (enforce !== Enforce) {
      throw new InstantiationError("Cannot instantiate ReportService directly. Use getInstance()");
    }
    super(enforce);
  ...
  public static getInstance(): ReportService {
    if (!ServiceManager.instance) {
      ServiceManager.instance = new ReportService(Enforce);
    }
    return ServiceManager.instance as ReportService;
  }
