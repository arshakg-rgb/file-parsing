...
import { JobStatus, ParseMessage, _FailureClass, JobCounts, totalFailed } from "../../shared/models/job.js";
 ...
 catch (rubbishErr) 
{
          ...
          case "uncertain":
            ...
            const failureClass = result.failure_class || _FailureClass.UNCERTAIN;
            try 
{
