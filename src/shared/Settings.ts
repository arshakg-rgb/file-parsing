...
export const settings = {
  ...
  LOAD_QUEUE_URL_SMALL: getString("LOAD_QUEUE_URL_SMALL", "fpp-load"),
  LOAD_QUEUE_URL_LARGE: getString("LOAD_QUEUE_URL_LARGE", "fpp-load"),
  ...
  OUTPUT_BUFFER_FLUSH_THRESHOLD_ROWS: getNumber("OUTPUT_BUFFER_FLUSH_THRESHOLD_ROWS", 5000),
